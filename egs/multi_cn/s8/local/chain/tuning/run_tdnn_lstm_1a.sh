...
affix=cnn_1a_3   # affix for the TDNN directory name
tree_affix=
train_stage=-10
get_egs_stage=-10
decode_iter=
...
if [ $stage -le 14 ]; then
  ...
  fast-lstmp-layer name=lstm3 cell-dim=1536 recurrent-projection-dim=256 non-recurrent-projection-dim=256 decay-time=20 delay=-3
