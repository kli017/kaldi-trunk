...
pre_train=exp/chain${nnet3_affix}/tdnn_1a_3_sp/120.mdl

# The rest are configs specific to this script.  Most of the parameters
# are just hardcoded at this level, in the commands below.
affix=1a_3   # affix for the TDNN directory name
tree_affix=
train_stage=-10
get_egs_stage=-10
decode_iter=
...
if [ $stage -le 14 ]; then
  ...
  tdnnf-layer name=tdnnf2 $tdnnf_opts dim=1536 bottleneck-dim=256 time-stride=1
