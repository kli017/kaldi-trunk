...
aidatatang_text=$1/transcript/aidatatang_200_zh_transcript_new.txt
data=$2
...
for dir in $train_dir $dev_dir $test_dir; do
  ...
  python local/word_segmentation_tab.py $dir/word_seg_vocab.txt $dir/trans_1.txt | sort -u > $dir/text
